...
//1.连接数据库
mongoose.connect('mongodb://localhost:27017/week8', {useNewUrlParser: true});
...
app.post('/new',function(req,res){
 ...
 var admin = new Student({
        ...
        pro:"<div class=\"progress-bar          progress-bar-danger progress-bar-striped active\" role=\"progressbar\" aria-valuenow=\"0\"aria-valuemin=\"0\" aria-valuemax=\"100\" id=\"pro\" style=\"min-width: 2em;\">0%</div>"
         })
